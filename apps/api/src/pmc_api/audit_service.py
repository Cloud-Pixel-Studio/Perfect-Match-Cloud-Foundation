...
def record(db: Session, *, tenant_id: UUID, actor_user_id: UUID, actor_display_name: str,
           actor_role: str, action: str, resource_type: str, resource_id: UUID | None,
           request_id: UUID, old_values: dict[str, object] | None = None,
           new_values: dict[str, object] | None = None,
           metadata: dict[str, object] | None = None) -> AuditEvent:
